# -*- coding: utf-8 -*-
"""
Created on Fri Jan 11 21:07:51 2019
...
#Creating Dictionary :mapping line and its id
...
# Two dictionaries mapping question and answer words to unique integers
...
# Inverse dictionary for answerswords2int
...
# Translating all question and answers into integers
# Replacing all words filtered out by <out>
...
def decode_test_set(encoder_state,
    ...
    test_decoder_function=tf.contrib.seq2seq.attention_decoder_fn_inference(output_function,
                                                                            ...
                                                                            num_words,
                                                                            name="attn_dec_inf")
    test_predictions,test_decoder_final_state,test_decoder_final_context_state=tf.contrib.seq2seq.dynamic_rnn_decoder(decoder_cell,
...
def seq2seq_model(inputs,
                  ...
                  keep_prob,
                  batch_size,
                  sequence_length,answers_num_words,questions_num_words,encoder_embedding_size,decoder_embedding_size,rnn_size,num_layers,questionswords2int):
...
# EPOCHS IS NUMBER OF TIMES TRAINING IS DONE
epochs=100
batch_size=64
rnn_size=512
num_layers=3
...
#To make the length of questions and answers are equal
